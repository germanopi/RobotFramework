...
FOR Loop with List
    ...
    FOR  ${MyItem}  IN  @{ITEMS}        # it will pass at item 1,2,3
       Log  ${MyItem}                   # will print item 1,2,3
    END
...
Exit a FOR Loop
    ...
    FOR  ${MyItem}  IN  @{ITEMS}
       Log  ${MyItem}
       Run Keyword If  "${MyItem}" == "Item 3"  Exit For Loop   # breakup a  loop
       Log  Didn't exit yet
    END
